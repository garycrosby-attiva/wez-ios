...
Defines the app's root presentation: a four-tab shell, per-tab navigation stacks,
presentation-driven tab-bar chrome, and the honest placeholder / navigable-empty-state
behaviour of the initial tabs before feature content exists.
